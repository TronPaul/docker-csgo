...
CMD ["/opt/steam/csgo/srcds_linux", "-game csgo", "-ip 0.0.0.0", "-port 27015", "-tickrate 128", "-usercon", "+sv_password changeme", "+rcon_password changeme", "+game_type 0", "+game_mode 1", "-notrap"]
